...
alphas = [1.0, 1.05, 1.15, 1.25, 1.5, 1.75, 2.0, 'detour']
with multiprocessing.Pool(len(alphas)*2) as pool:
...
alpha, _, edge_betw = get_rb(filename, 'edge', 'all')
...
alpha, _, node_betw = get_rb(filename, 'node', 'all')
